...
- [ ] Generate Dog Handler idle/walk/attack sheets — blocked: Kling node errors and insufficient generation balance
- [ ] Deploy the static build to Railway — blocked: supplied Railway token returns `Unauthorized`
