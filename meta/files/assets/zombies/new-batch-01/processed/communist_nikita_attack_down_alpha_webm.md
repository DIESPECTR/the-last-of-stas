---
SECTION_ID: files.assets.zombies.new-batch-01.processed.communist_nikita_attack_down_alpha_webm
TYPE: file/video
---

# Communist Nikita attack_down transparent sheet

FILE: assets/zombies/new-batch-01/processed/communist_nikita_attack_down_alpha.webm
DESCRIPTION: Transparent source video and fixed 4×4 game sprite sheet for Communist Nikita's down-facing attack.
USAGE: Runtime attack_down animation, 16 tiles at 128×128.
