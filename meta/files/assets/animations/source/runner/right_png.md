---
SECTION_ID: files.assets.animations.source.runner.right_png
TYPE: file/image
---

# Runner Master — Facing Right (Photoreal)

FILE: assets/animations/source/runner/right.png
UTILITY: gpt_image
WIDTH: 1024
HEIGHT: 1024
DESCALE: 2
...
PROMPT: |
  ...
  Pose: aggressive forward-leaning sprint stance, full body profile facing right (mirror of left pose),
  clawed hand reaching forward, back leg extended trailing behind on the left side of frame.
