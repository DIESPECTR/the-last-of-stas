---
SECTION_ID: files.assets.animations.source.runner.left_png
TYPE: file/image
---

# Runner Master — Facing Left (Photoreal)

FILE: assets/animations/source/runner/left.png
UTILITY: gpt_image
WIDTH: 1024
HEIGHT: 1024
DESCALE: 2
...
PROMPT: |
  ...
  Pose: aggressive forward-leaning sprint stance, full body profile facing left, clawed hand reaching
  forward, back leg extended trailing behind on the right side of frame.
