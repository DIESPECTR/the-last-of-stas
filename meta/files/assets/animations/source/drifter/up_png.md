---
SECTION_ID: files.assets.animations.source.drifter.up_png
TYPE: file/image
---

# Drifter Master — Facing Up (Photoreal)

FILE: assets/animations/source/drifter/up.png
UTILITY: gpt_image
WIDTH: 1024
HEIGHT: 1024
DESCALE: 2
...
PROMPT: |
  ...
  Pose: relaxed exhausted standing shamble stance, seen from directly behind/above, walking away from
  camera — back of coat, back of head, hanging shoulder visible.
