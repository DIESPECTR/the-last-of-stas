---
SECTION_ID: files.assets.animations.source.drifter.right_png
TYPE: file/image
---

# Drifter Master — Facing Right (Photoreal)

FILE: assets/animations/source/drifter/right.png
UTILITY: gpt_image
WIDTH: 1024
HEIGHT: 1024
DESCALE: 2
...
PROMPT: |
  ...
  Pose: relaxed exhausted standing shamble stance, full body profile facing right (mirror of left pose),
  dragging foot trailing behind on the left side of frame.
