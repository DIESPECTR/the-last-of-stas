---
SECTION_ID: files.assets.animations.source.spitter.left_png
TYPE: file/image
---

# Spitter Master — Facing Left (Photoreal)

FILE: assets/animations/source/spitter/left.png
UTILITY: gpt_image
WIDTH: 1024
HEIGHT: 1024
DESCALE: 2
...
PROMPT: |
  ...
  Pose: heavy hunched standing stance, full body profile facing left, oversized shoulder leading,
  dangling arm trailing behind on the right side of frame.
