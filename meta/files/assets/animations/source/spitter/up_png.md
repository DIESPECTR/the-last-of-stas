---
SECTION_ID: files.assets.animations.source.spitter.up_png
TYPE: file/image
---

# Spitter Master — Facing Up (Photoreal)

FILE: assets/animations/source/spitter/up.png
UTILITY: gpt_image
WIDTH: 1024
HEIGHT: 1024
DESCALE: 2
...
PROMPT: |
  ...
  Pose: heavy hunched standing stance, seen from directly behind/above, back of overalls, swollen
  oversized shoulder and hunched back visible.
