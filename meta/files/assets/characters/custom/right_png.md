---
SECTION_ID: files.assets.characters.custom.right_png
TYPE: file/image
---

# Stas Master — Facing Right

FILE: assets/characters/custom/right.png
UTILITY: gpt_image
QUALITY: high
WIDTH: 1024
HEIGHT: 1024
...
USAGE: Static animation master. Fed to wan for idle/walk/attack right-facing clips.

PROMPT: |
  Isolated photoreal game-character master of the EXACT man from @image1, full-body right profile.
  ...
  Pose: relaxed standing idle, full body profile facing right. Hands empty, no weapon, no prop.
...
- Must match down/up/left in identity, proportions and scale — only facing changes.
