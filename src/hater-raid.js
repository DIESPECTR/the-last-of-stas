...
export const RAID_TABS={
  originals:['communist_nikita','tattooed_crowd_zombie','blonde_crowd_zombie','plaid_glasses_zombie','brunette_crowd_zombie','cat_keeper','vomiting_alexander','lilliput','lumberjack_zombie','injured_kuok'],
